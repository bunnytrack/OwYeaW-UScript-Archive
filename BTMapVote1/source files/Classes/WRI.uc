...
var() 	class <UWindowWindow> 	WindowClass;     						// ќпределение типа окна
...
//-----------------------------------------------------------------------------
// Post(Net)BeginPlay - это симулированна€ функци€, котора€ вызываетс€ везде, and creates a window on the appropriate machine.
