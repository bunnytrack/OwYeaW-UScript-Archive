...
var() 	class <UWindowWindow> 	WindowClass;     						// Определение типа окна
...
//-----------------------------------------------------------------------------
// Post(Net)BeginPlay - это симулированная функция, которая вызывается везде, and creates a window on the appropriate machine.
